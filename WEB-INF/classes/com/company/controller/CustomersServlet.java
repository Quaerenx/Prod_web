    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("list".equals(viewType)) {
            ...
            if (customerName != null && !customerName.isEmpty()) {
                ...
                request.getRequestDispatcher("/customers/detail.jsp").forward(request, response);
            } else {
            ...
            if (customerName != null && !customerName.isEmpty()) {
                ...
                request.getRequestDispatcher("/customers/customer_detail_edit.jsp").forward(request, response);
            } else {
                response.sendRedirect("customers?view=list");
            }
